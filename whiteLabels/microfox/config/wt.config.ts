 export const WT_CONFIG = {
    CRM_BASE_URL:'https://democrm.microfox.io',
    BO_BASE_URL:'https://devwt.mt4.space:24999',
    TERMS_CONDITIONS:'https://democrm.microfox.io',
    ABOUT_US: 'https://democrm.microfox.io',
    CRM_APP: 'https://democrm.microfox.io',
	  FOX_BASE_URL: '',
