 export const WT_CONFIG = {
    CRM_BASE_URL:'https://aaa.rcmfx.com',
    BO_BASE_URL:'https://rcmwt.mt4.space:29999',
	FOX_BASE_URL:'',
    TERMS_CONDITIONS: 'https://s3-ap-southeast-1.amazonaws.com/rcmfx/ppt/RCM+TOS+(Chi)+v2(1).pdf',
    ABOUT_US: 'https://rcmfx.com',
    CRM_APP: 'https://my.rcmfx.com',
    ...
    IMAGE_ROOT: 'rcmfx',
	GA_TRACKING_CODE: 'UA-123757204-7'
 };
