export const WT_CONFIG = {
     CRM_BASE_URL:'https://aaa.stt-fx.com/',
    BO_BASE_URL:'https://sttfxwt.mt4.space:30999',
	FOX_BASE_URL:'',
    TERMS_CONDITIONS: 'https://my.stt-fx.com',
    ABOUT_US: 'https://my.stt-fx.com',
    CRM_APP: 'https://my.stt-fx.com',
    ...
    IMAGE_ROOT: 'sttfx',
	GA_TRACKING_CODE: 'UA-123757204-12'
 };
