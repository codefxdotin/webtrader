export const WT_CONFIG = {
    CRM_BASE_URL:'https://aaa.sky9co.com',
    BO_BASE_URL:'https://skylwt.mt4.space:24999',
	FOX_BASE_URL:'',
    TERMS_CONDITIONS: 'https://sky9co.com/cn/aboutus-secrecy.html',
    ABOUT_US: 'https://sky9co.com/cn/aboutus_bg.html',
    CRM_APP: 'https://my.sky9co.com/',
    ...
    IMAGE_ROOT: 'sky9fx',
	GA_TRACKING_CODE: 'UA-123757204-3'
 };
