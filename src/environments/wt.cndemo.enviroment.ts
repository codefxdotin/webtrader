export const WT_CONFIG = {
  CRM_BASE_URL: 'https://fxaxis-backend.broctagon.com',
  BO_BASE_URL: 'https://whalestagewt.mt4.space:23998',
  ...
  getFoxAPI: false,
  s3BucketPath: "https://bbv2-fxcrm-microfox-frontend.s3.ap-northeast-2.amazonaws.com/",

  ABOUT_US: 'https://fxcrm.microfox.io',
  CRM_APP: 'https://fxcrm.microfox.io',
  BRAND_NAME: 'CRM',
