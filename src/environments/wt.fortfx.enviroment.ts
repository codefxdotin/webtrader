export const WT_CONFIG = {
    CRM_BASE_URL:'https://aaa.fort-fx.com',
    BO_BASE_URL:'https://fortwt.mt4.space:23999',
	  FOX_BASE_URL:'',
    TERMS_CONDITIONS:'https://broc-docs.s3.amazonaws.com/Fort%20T%26C%20ZH.pdf',
    ABOUT_US: 'https://fort-fx.com/',
    CRM_APP: 'https://my.fort-fx.com',
    ...
    IMAGE_ROOT: 'fortfx',
    GA_TRACKING_CODE: 'UA-123757204-6',

    languages: [
        {name:"English", code:"en", flagUrl:"assets/images/us-flag.png"},
        {name:"中文", code:"zh", flagUrl:"assets/images/zh-flag.png"},
        {name:"ไทย", code:"th", flagUrl:"assets/images/th-flag.png"},
        {name:"Tiếng Việt", code:"vi", flagUrl:"assets/images/vi-flag.png"}
      ]
 };
