...
export const WT_CONFIG = {
  CRM_BASE_URL: 'https://bb-v2-backend-vt.whale-inc.com',
  BO_BASE_URL: 'https://whalesvnwt.mt4.space:20998',
  BO_DEMO_BASE_URL: 'https://whalesvnwt.mt4.space:20998',
  ...
  getFoxAPI: false,
  s3BucketPath: "https://vietnam-prod-bbv2-frontend.s3.ap-east-1.amazonaws.com/",



  ABOUT_US: 'https://whale-inc.com/about/about-whale/',
  CRM_APP: 'https://myvn.whale-inc.com',
  BRAND_NAME: 'Whale (Vietnam)',
  ...
  IMAGE_ROOT: '',
  GA_TRACKING_CODE: 'UA-122763789-4',
